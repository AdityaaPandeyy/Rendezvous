...
const PostWidget = ({
    ...
    const handleAddComment = async () => {
        ...
        const response = await fetch(`http://localhost:7001/posts/${postId}/comment`, {
          method: "PATCH",
          headers: {
    ...
    const handleLikeClick = async () => {
        const response = await fetch(`http://localhost:7001/posts/${postId}/like`, {
            method: "PATCH",
            headers: {
                Authorization: `Bearer ${token}`,
                "Content-Type": "application/json",
        ...
        <WidgetWrapper m="2rem 0">
            ...
            {picturePath && (
                <img
                    ...
                    src={`http://localhost:7001/assets/${picturePath}`}
                />
            )}
